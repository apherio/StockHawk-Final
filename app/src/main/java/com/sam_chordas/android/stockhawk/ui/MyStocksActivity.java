...
import com.sam_chordas.android.stockhawk.touch_helper.RecyclerViewEmptySupport;
...
public class MyStocksActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        RecyclerViewEmptySupport recyclerView = (RecyclerViewEmptySupport) findViewById(R.id.recycler_view);
        ...
        recyclerView.addOnItemTouchListener(new RecyclerViewItemClickListener(this,
                new RecyclerViewItemClickListener.OnItemClickListener() {
                    ...
                    public void onItemClick(View v, int position) {
                        ...
                        // do something on item click
                        Intent graphIntent = new Intent(mContext, com.sam_chordas.android.stockhawk.ui.DetailActivity.class);
    ...
    public void networkToast() {
        ...
        Snackbar snackbar = Snackbar
                .make(coordinatorLayout, getString(R.string.network_toast), Snackbar.LENGTH_LONG)
